...
-- Description:	<Retorna la localidad normalizada y el codigo de la localidad>
-- =============================================
ALTER FUNCTION [dbo].[localidades_normalizar]
(
	@localidad nvarchar(100)
)
RETURNS @listaLocalidad TABLE (localidad VARCHAR(100),codigoLocalidad int)
...
begin 
	...
	insert into @listaLocalidad (localidad,codigoLocalidad)	
	values(
			@localidadSalida
			,@codLocSalida
		  )
